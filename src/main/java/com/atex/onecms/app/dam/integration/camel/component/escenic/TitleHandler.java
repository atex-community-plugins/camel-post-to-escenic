...
//		String ss = StringEscapeUtils.unescapeXml(StringEscapeUtils.unescapeXml(stringWriter.toString()));
//		return ss;
	...
	public Object marshal(String v) throws Exception {
		String ss = StringEscapeUtils.unescapeXml(StringEscapeUtils.unescapeHtml(v));
		return "<![CDATA[" + v + "]]>";
//		return ss;
//		return Arrays.asList(new Object[]{v});
