...
public class EscenicArticleProcessor extends EscenicContentProcessor {
	...
	private String processArticle(OneArticleBean article, Entry existingEntry, List<EscenicContent> escenicContentList, EscenicConfig escenicConfig, String action) {
		...
		Title title = escenicUtils.createTitle(escenicUtils.processAndReplaceOvermatterAndNoteTags(escenicUtils.getStructuredText(article.getHeadline())), "text");
		Summary summary = escenicUtils.createSummary(escenicUtils.processAndReplaceOvermatterAndNoteTags(escenicUtils.getStructuredText(article, "subHeadline")), "text");
	...
	protected List<Field> generateArticleFields(OneArticleBean oneArticleBean, List<EscenicContent> escenicContentList, String embargoTime) {
		...
		fields.add(escenicUtils.createField("title", escenicUtils.escapeXml(escenicUtils.processAndReplaceOvermatterAndNoteTags(escenicUtils.getStructuredText(articleBean.getHeadline()))), null, null));
